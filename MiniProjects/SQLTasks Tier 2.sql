...
FROM(
SELECT DISTINCT f.name, b.facid, b.memid
FROM Bookings AS b
...
AND (((Facilities.guestcost * Bookings.slots >30) AND (Bookings.memid =0))
...
SELECT (m.surname, m.firstname, m.recommendedby 
AS recomender_id, r.surname AS recomender_surname, r.firstname AS recomender_firstname)
FROM Members AS m
...
FRom Bookings
WHERE memid != 0 ) AS b
LEFT jOin Facilities as f on b.facid = facid
GROUP BY b.facid;
